...
export class ArrayProperty extends Property {
  ...
  get ArraySize() {
    if (this.StoredPropertyType === 'IntProperty\0') return 12;
    else return this.Size - this.HeaderSize;
  }
  deserialize(serial) {
    serial.seek(4);
  ...
  serialize() {
    ...
    serial.seek(1);
    serial.writeInt32(this.Property.Count);
    // serial.seek(2);
